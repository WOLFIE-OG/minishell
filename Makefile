...
#    Updated: 2024/11/06 16:33:19 by otodd            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFLAGS 		= 	-Wall -Wextra -Werror -std=c99 -g -D_POSIX_C_SOURCE=200809L -fPIC # -fsanitize=address
NAME		= 	minishell
...
SRCS		=	$(SRC_DIR)/main.c \
				...
				$(SRC_DIR)/ft_tokeniser_helpers/ft_bool_quotes.c \
